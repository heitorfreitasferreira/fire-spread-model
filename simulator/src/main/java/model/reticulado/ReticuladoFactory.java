...
public class ReticuladoFactory {
    ...
    public static ReticuladoParameters fromJson(JsonObject json, int quantidadeIteracoes) {
        ...
        return new ReticuladoParameters(initialPoints, terrainArray.length, terrainArray[0].length, humidity,
                windDirection, terrainArray, new GeradorDeMatriz(slopeArray), quantidadeIteracoes);
    }
