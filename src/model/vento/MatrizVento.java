...
public class MatrizVento {
    ...
    private MatrizVento (double coef, double mult_base, double decai,Enum<DirecoesVento> direcao){
        this.coef = coef;
    ...
    public static MatrizVento getInstance(double coef, double mult_base, double decai, Enum<DirecoesVento> direcao){
        ...
        if(!instance.direcao.equals(direcao)) instance = new MatrizVento(coef, mult_base, decai, direcao);
        return instance;
    }
    public static MatrizVento getInstance(){
        if(instance == null) throw new IllegalStateException("Matriz de vento não inicializada com parametros");
        return instance;
    }
