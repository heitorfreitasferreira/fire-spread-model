...
//        }
    ...
    protected double[][] getRandomMatriz() {
        ...
        double[][] matriz =
            new double[neighborhoodSize][neighborhoodSize];
    ...
    protected void avancarQueimavel(
        Celula celula, EnumMap<Estados, boolean[][]> estadoMatriz, Celula[][] neighborhood, double[][] matrizVento) {
    ...
    private void setTransicoes() {
        ...
        // TODO: Ver com o Luiz se esse comportamento faz sentido (problema: solo exposto irá transicionar para vegetação??)
    }
